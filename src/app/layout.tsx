...
export const metadata: Metadata = {
  ...
  keywords: ['portofolio akademik', 'publikasi ilmiah', 'pengabdian masyarakat', 'riset', 'penelitian', 'opini', 'buku'],
  authors: [{ name: 'Dadang' }],
  openGraph: {
    title: 'Dadang — Portofolio Akademik & Profesional',
    description: 'Publikasi, pengabdian masyarakat, dan aktivitas akademik dalam satu portofolio.',
  ...
  alternates: { canonical: 'https://dadang-portofolios.vercel.app' },
}
